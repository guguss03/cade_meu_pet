...
<body>
        ...
        <div class="menu">
            <nav>
                ...
                <ul>
                    ...
                    <a href="postsocial.hphptml"><li>Insira seu post</li></a>
                    <div class="dropdown">
    ...
    <div class="conteudo">
        <div class="fundodoconteudo"> 
            ...
            <div class="card">
                <div class="img-card">
                    <img src="img/claire.jpeg" alt="" width="100%" height="110%">  
                </div>
                <div class="cont-card">
                    
                    <div class="cont-card-titulo">
                        CLAIRE
                        <div class="raca">Raça: Fila Brasileiro</div>
                        <div class="regiao">Desapareceu em:  Jarinu - SP</div>
                    </div>
...
<footer class="rodape2">
            ...
            <p class= "text1" id="rodape">Alunos da turma TI-97, do curso técnico em informpatica do Senac Largo Treze, desenvolvendo um projeto para o curso com foco em animais perdidos. 
